...
from python.qiskit.grover import search
...
def test_grover_search() -> None:
    ...
    found, dist = search(4, 11, aer_sampler, pm, num_shots=100)
...
def test_grover_search_explicit_iterations() -> None:
    ...
    # n=3, target=5: optimal is 2, but we override with 2 explicitly here.
